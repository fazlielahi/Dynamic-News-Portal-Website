...
<?php
	...
	foreach($topstory as $top)
	{
		...
		{
			$image = " <a href='news.php?id=$top[id]&type=news'>
							<img src='$dir_images/large/default.png' width='400' />
						</a>	
					";
		}
	...
	foreach($all_latest_news as $latest_news)
	{
		...
		}else
		{
			...
			$image = " <div class='image'>
							<a href='news.php?id=$latest_news[id]&type=news' >
								<img src='$dir_images/default.png' width='200' />
							</a>
						</div> ";
		}
	...
	//  categories news from 3 4 5

	$all_categ = get_categories("all_caregories", "", 3, "ASC", 2);
	$category_list2 = "";
...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="../portfolio/styles/header.css" /> <!-- main heading css -->
	...
	<body onresize="show_menu()">
		...
		<!-- categories news 3, 4, 5 -->
		<div class='categ_news_desc'>	
